                ...
                >
                  ...
                  <div className="grid gap-3 md:grid-cols-3">
                    ...
                    <input
                      name="reviewed_at"
                      type="date"
                      defaultValue={testimonial.reviewed_at || ""}
                      className="rounded-md border border-border px-3 py-2 text-sm"
                    />
                    <select
                      name="status"
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    ...
                    <MoveOrderButtons
                      moveUpAction={moveTestimonial.bind(
                        null,
                        testimonial.id,
                        "up"
                      )}
                      moveDownAction={moveTestimonial.bind(
                        null,
                        testimonial.id,
                        "down"
                      )}
                    ...
                    />
                    <ConfirmButton
                      formAction={deleteTestimonial.bind(null, testimonial.id)}
